...
export default function LandingUserCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new LandingUser(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "LandingUserCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
